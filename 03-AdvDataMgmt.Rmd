...
![](Figures/Chapter 11/searching-r-tree.png)
...
![](Figures/Chapter 12/graph-portfolio.png)
...
![](Figures/Chapter 12/unrelated-nodes.png)
...
![](Figures/Chapter 12/graph-nation-stock.png)
...
![](Figures/Chapter 12/graph-sales.png)
...
![](Figures/Chapter 12/view-sales-items.png)
...
![](Figures/Chapter 12/graph-monarch.png)
...
![](Figures/Chapter 12/monarch-succession.png)
...
![](Figures/Chapter 12/graph-NorthWinds)
...
![](Chapter 15/Figures/gather-spread.png)
...
tagged.text <- koRpus::tokenize(as.character(txt),format="obj",lang="en")
# score
...
that have added graduate courses in data analytics. The **Lambda Architecture**[^46] 
is a proposed general solution to the speed and cost
problem.
...
1.  Write Spark code for the following situations.
    ...
    e. Read the national GDP file,[^55] which records GDP in millions,
...
*A dashboard \<[[http://www.ecoresearch.net/climate/]{.underline}](http://www.ecoresearch.net/climate/)\>*

![](Figures/Chapter 19/climate-dashboard.png)
...
![](Figures/Chapter 19/dashboard-1.png)
...
* The data to be graphed are retrieved with the Cl function of the quantmod package.[^58]
